...
SECRET_KEY = "django-insecure-(h^oi83b8mw!bak46-^b@r7=xxc-%t$f@f_e#u8km(ztnm8k8f"
...
INSTALLED_APPS = [
    ...
    "cmsm_PROJECT.apps.DjangoAppConfig",
]
...
WSGI_APPLICATION = "cmsm_PROJECT.wsgi.application"
